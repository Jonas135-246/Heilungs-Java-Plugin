...
Ein maßgeschneidertes Server-Plugin für Minecraft (Paper-API für Version 1.21.1 / Spigot-kompatibel), das einen interaktiven Chat-Befehl zur Heilung von Spielern hinzufügt.

### Funktionen
- **`/heilung` Befehl:** Setzt die Lebenspunkte des ausführenden Spielers sofort auf das Maximum (20.0 Punkte / 10 volle Herzen).
- **Farbiger Chat-Feedback:** Sendet eine Erfolgsmeldung in grün (`§a`) direkt an den Spieler.
